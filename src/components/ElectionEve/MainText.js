...
social services and programs proven to reduce violence</a>, and overwhemingly believe in a reduction of the number of people in jails and prisons, as well as allowing people who are incarcerated to use Pell Grants to advance their education and training. At Vera, we are working with local community leaders nationwide to organize and empower their neighborhoods and communities.</p>
        </Container>
        </>
    )
}
